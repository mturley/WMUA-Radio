...
// Discogs-ObjC
#define COCOAPODS_POD_AVAILABLE_Discogs_ObjC
#define COCOAPODS_VERSION_MAJOR_Discogs_ObjC 0
#define COCOAPODS_VERSION_MINOR_Discogs_ObjC 1
#define COCOAPODS_VERSION_PATCH_Discogs_ObjC 1
